...
\begin{tabular}{@{} l l l @{}}
  \toprule
  \textbf{Rôle} & \textbf{E-mail} & \textbf{Mot de passe} \\
  \midrule
  Administrateur & \texttt{admin@medisync.demo}     & \texttt{Demo1234!} \\
  Médecin        & \texttt{doctor@medisync.demo}    & \texttt{Demo1234!} \\
  Secrétaire     & \texttt{secretary@medisync.demo} & \texttt{Demo1234!} \\
  Patient 1      & \texttt{patient@medisync.demo}   & \texttt{Demo1234!} \\
  Patient 2      & \texttt{patient2@medisync.demo}  & \texttt{Demo1234!} \\
  \bottomrule
\end{tabular}
\end{center}
...
\begin{itemize}[leftmargin=*,itemsep=3pt]
  \item \textbf{Planning global} : Vue hebdomadaire de tous les RDV. Actions : confirmation, no-show, rescheduling.
